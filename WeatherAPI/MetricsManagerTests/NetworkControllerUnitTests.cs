...
namespace MetricsManagerTests
{
    public class NetworkControllerUnitTests
    {
        ...
        private Mock<IRepositoryMM<NetworkMetric>> _mock;
        ...
        public NetworkControllerUnitTests()
        {
            ...
            _mock = new Mock<IRepositoryMM<NetworkMetric>>();
            _mapper = new Mock<IMapper>();
            _agent = new Mock<IAgentsRepository<AgentInfo>>();
            _controller = new NetworkMetricsController(_logger.Object, _client.Object, _mock.Object, _mapper.Object, _agent.Object);
        }
