...
namespace MetricsManagerTests
{
    public class HddControllerUnitTests
    {
        ...
        private Mock<IRepositoryMM<HddMetric>> _mock;
        ...
        public HddControllerUnitTests()
        {
            ...
            _mock = new Mock<IRepositoryMM<HddMetric>>();
            _mapper = new Mock<IMapper>();
            _agent = new Mock<IAgentsRepository<AgentInfo>>();
            _controller = new HddMetricsController(_logger.Object, _client.Object, _mock.Object, _mapper.Object, _agent.Object);
        }
